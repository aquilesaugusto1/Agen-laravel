            ...
            <header class="absolute inset-x-0 top-0 z-50">
                <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                    ...
                    <div class="lg:flex lg:flex-1 lg:justify-end">
                        @auth
                            <a href="{{ route('dashboard') }}" class="text-sm font-semibold leading-6 text-white hover:text-indigo-400">Aceder ao Painel <span aria-hidden="true">&rarr;</span></a>
                        @else
        ...
        <section id="equipa" class="bg-slate-900 py-24 sm:py-32">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl lg:mx-0">
                    <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">A Equipa por De trás do Código</h2>
