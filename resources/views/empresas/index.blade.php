                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($empresas as $empresa)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-bold {{ $empresa->horas_contratadas < 0 ? 'text-red-600' : 'text-gray-700' }}">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        ...
                                        <form action="{{ route('empresas.destroy', $empresa) }}" method="POST" class="inline ml-4">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="text-red-600 hover:text-red-900" onclick="return confirm('Tem certeza que deseja remover esta empresa?')">
                                                Remover
                                            </button>
                                        </form>
                                    </td>
